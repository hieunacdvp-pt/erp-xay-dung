...
__decorate([
    (0, common_1.Post)('register/options/:username'),
...
__decorate([
    (0, common_1.Post)('register/verify/:username'),
    __param(0, (0, common_1.Param)('username')),
...
__decorate([
    (0, common_1.Post)('login/options/:username'),
    __param(0, (0, common_1.Param)('username')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "getAuthenticationOptions", null);
__decorate([
    (0, common_1.Post)('login/verify/:username'),
    __param(0, (0, common_1.Param)('username')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
