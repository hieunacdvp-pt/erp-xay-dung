...
export declare class EnterpriseController {
    ...
    getSettings(): {
        valuationMethod: "AVERAGE" | "FIFO";
    };
    setSettings(method: 'AVERAGE' | 'FIFO'): {
        success: boolean;
        method: "AVERAGE" | "FIFO";
    };
    ...
    createVendor(body: any): import("@prisma/client").Prisma.Prisma__VendorClient<{
        id: number;
        createdAt: Date;
        name: string;
        phone: string | null;
    ...
    updateVendor(id: string, body: any): import("@prisma/client").Prisma.Prisma__VendorClient<{
        id: number;
        createdAt: Date;
        name: string;
        phone: string | null;
    ...
    createDebt(body: any): import("@prisma/client").Prisma.Prisma__DebtClient<{
        id: number;
        createdAt: Date;
        type: string;
        amount: number;
    ...
    payDebt(id: string, amount: number, accountId: number, bankFee: number): Promise<{
        id: number;
        createdAt: Date;
        type: string;
        amount: number;
    ...
    createMovement(body: any): Promise<{
        id: number;
        date: Date;
        projectId: number;
        type: string;
