...
exports.SubcontractsController = void 0;
const common_1 = require("@nestjs/common");
const subcontracts_service_1 = require("./subcontracts.service");
let SubcontractsController = class SubcontractsController {
    subcontractsService;
    constructor(subcontractsService) {
        this.subcontractsService = subcontractsService;
    }
    create(data) {
...
], SubcontractsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SubcontractsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], SubcontractsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], SubcontractsController.prototype, "update", null);
__decorate([
    (0, common_1.Post)(':id/acceptances'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], SubcontractsController.prototype, "createAcceptance", null);
...
//# sourceMappingURL=subcontracts.controller.js.map